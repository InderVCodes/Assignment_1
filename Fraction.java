...
public class Fraction implements PJ1.FractionInterface, Comparable<Fraction> {
    private int num;
    private int den;
    ...
    public void setFraction(int num, int den) {
        this.num = num;
        if (den == 0) throw new PJ1.Project1Exception("Denominator is 0");
        this.den = den;
        adjustSigns();
    ...
    public PJ1.FractionInterface add(PJ1.FractionInterface secondFraction) {
    ...
    public PJ1.FractionInterface subtract(PJ1.FractionInterface secondFraction) {
        Fraction op = (Fraction) secondFraction;
        int newNumerator = num * op.den - op.num * den;
        int newDenominator = den * op.den;
        Fraction r = new Fraction(newNumerator, newDenominator);
    ...
    public PJ1.FractionInterface multiply(PJ1.FractionInterface secondFraction) {
    ...
    public PJ1.FractionInterface divide(PJ1.FractionInterface secondFraction) {
        Fraction div = (Fraction) secondFraction;
        if (div.num == 0) throw new PJ1.Project1Exception("Divisor is 0");
